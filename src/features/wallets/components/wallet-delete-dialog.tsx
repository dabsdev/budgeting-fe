import { useDeleteWalletMutation } from "../api/wallet.mutations";
...
export function WalletDeleteDialog({ isOpen, onClose, wallet }: WalletDeleteDialogProps) {
            ...
            >
              ...
              <div className="p-6 text-center space-y-4">
                ...
                <div className="space-y-1.5 text-center">
                  <h3 className="text-lg font-bold text-zinc-900">Delete Wallet</h3>
                  <p className="text-xs text-zinc-500 max-w-[280px] mx-auto leading-relaxed">
                    Are you sure you want to delete <span className="font-semibold text-zinc-800">"{wallet.name}"</span>? This action will archive the wallet and cannot be undone.
                  </p>
                </div>
